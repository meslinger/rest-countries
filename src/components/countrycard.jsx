...
const CountryCard = ({ ctry }) => {
    return (
        <Link to={`/${ encodeURI(ctry.name.common) }`} className="shadow-md hover:scale-105 max-w-[256px]">
            <div>
                <img src={ctry.flags.png} alt={ ctry.flags.alt && ctry.flags.alt !== '' ? ctry.flags.alt : 'Flag of ' + ctry.name.common } className="w-64 h-40 rounded-t-md" />
